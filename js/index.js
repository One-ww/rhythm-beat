...
audio1.addEventListener('play', function (e) {
  ...
  if (currentPlayingAudio && currentPlayingAudio !== audio1) {
...
audio2.addEventListener('play', function (e) {
  ...
  AnimationFrameId = requestAnimationFrame(animate)
  if (currentPlayingAudio && currentPlayingAudio !== audio2) {
    currentPlayingAudio.pause()
  }
...
audio3.addEventListener('play', function (e) {
  ...
  AnimationFrameId = requestAnimationFrame(animate)
  if (currentPlayingAudio && currentPlayingAudio !== audio3) {
    currentPlayingAudio.pause()
  }
